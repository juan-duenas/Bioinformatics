...
### decipher.r
Example script to taxonomically annotate operational taxonomic units or amplicon sequence variants with the [IDTaxa](https://doi.org/10.1186/s40168-018-0521-5) algorithm. This example uses the Silva 16s database [v. 138.1](https://www.arb-silva.de/download/archive/, https://academic.oup.com/nar/article/41/D1/D590/1069277) as a reference for taxonomic annotation.
